...
import validCommandWords, { commandsWith1Param, commandsWith2Params, } from "../constants/validCommandWords.js";
...
function parseCommand(command) {
    try {
        ...
        parsedCommand.commandWord = expandAbbreviatedString(splitCommand[0].toLowerCase(), validCommandWords);
