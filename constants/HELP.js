...
const HELP = {
    ...
    CHEATSHEET: [
        ...
        `${padStringToLength80(`Common Commands in Restoria: Type HELP CHEATSHEET in-game to see this again.`, ` `)}`,
    ...
    ERASE: [
        `${padStringToLength80(`ERASE, DELETE, ERASE ITEM, ERASE MOB, ERASE ROOM`)},`,
        `User the ERASE or DELETE command to ERASE ITEM, ERASE MOB, or ERASE ROOM in your zone.`,
    ...
    HIDDEN: [
        `This feature is still in development.`,
        `${padStringToLength80(`HIDDEN_ITEM, HIDDEN_USER, HIDDEN_MOB, HIDDEN_EXIT`)},`,
    ],
    ITEM_NODE: [
    ...
    ITEM_TYPE: [
        `This feature is still in development.`,
        `${padStringToLength80(`ITEM_TYPE, ARMOR, POTION, SCROLL, TOKEN, TREASURE, WAND, WEAPON, FISHING_ROD`)},`,
        `When fully implemented, an item's type will determine what can be done with that item.`,
    ...
    JOB: [
        ...
        `<span style="color:var(--red)">Cleric:</span> Learns spells for healingand protection, and some for damaging foes.`,
    ...
    MOB_NODE: [
        ...
        `An mob node spawns a specific mob into the room when the zone is spawned.`,
    ...
    STATS: [
        `This feature is still in development.`,
        `${padStringToLength80(`STATS, HP, MP, MV, STR, DEX, CON, INT, WIS, SPIRIT`)},`,
