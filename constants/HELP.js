...
const HELP = {
    ...
    CHEATSHEET: [
        ...
        `After you log in, try typing these in the command box at the bottom:`,
        `<span style="color:var(--yellow)">To explore:</span>`,
        `<span style="color:var(--green)">NORTH</span>, <span style="color:var(--green)">EAST</span>, <span style="color:var(--green)">SOUTH</span>, <span style="color:var(--green)">WEST</span>, <span style="color:var(--green)">UP</span>, <span style="color:var(--green)">DOWN</span>: move in any direction`,
        `<span style="color:var(--green)">LOOK:</span> see what (and who) is in the room with you`,
        `<span style="color:var(--green)">EXITS:</span> see where you can move from your location`,
        `<span style="color:var(--green)">RECALL:</span> warp back to "The Snails", the centre of Restoria Town`,
        `<span style="color:var(--yellow)">To communicate with other players:</span>`,
        ...
        `<span style="color:var(--yellow)">To be an author in the game:</span>`,
    ...
    ITEM_TAG: [
        ...
        `<span style="color:var(--red)">Moon:</span> players with moon-aligned spirit (<=-300) can use or equip it`,
        `<span style="color:var(--red)">Neutral:</span>players with a neutral spirit (-300 to 300) can use or equip it`,
        `<span style="color:var(--red)">Sun:</span> players with a sun-aligned spirit (>=300) can use or equip it`,
