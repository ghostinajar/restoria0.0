...
const HELP: {
  ...
  CHEATSHEET: [
    ...
    `<span style="color:var(--yellow)">To explore,</span> move <span style="color:var(--green)">NORTH</span>, <span style="color:var(--green)">EAST</span>, <span style="color:var(--green)">SOUTH</span>, <span style="color:var(--green)">WEST</span>, <span style="color:var(--green)">UP</span>, <span style="color:var(--green)">DOWN</span> to go to different rooms, or check the <span style="color:var(--green)">EXITS</span> to see where you can go. <span style="color:var(--green)">LOOK</span> at the <span style="color:var(--orange)">rooms</span>, <span style="color:var(--blue_light)">items</span>, and creatures (aka "<span style="color:var(--green)">mobs</span>") in the room with you. <span style="color:var(--green)">GET</span>, <span style="color:var(--green)">DROP</span>, or <span style="color:var(--green)">GIVE</span> items, <span style="color:var(--green)">PUT</span> them into container items, and <span style="color:var(--green)">WEAR</span> equipment items. If you get lost, <span style="color:var(--green)">RECALL</span> to warp back to "The Snails", the centre of Restoria Town.`,
    `<span style="color:var(--yellow)">To communicate with other players,</span> <span style="color:var(--green)">SAY</span> something to the room you're in, <span style="color:var(--green)">SHOUT</span> it to everyone nearby, or <span style="color:var(--green)">TELEPATH:</span> a message to a single user.`,
    `<span style="color:var(--yellow)">To author new parts of the game</span>, try <span style="color:var(--green)">CREATE ZONE</span> to build your own story environment outside Restoria City, then <span style="color:var(--green)">GOTO</span> that area and start to <span style="color:var(--green)">CREATE</span> your own rooms, items, and mobs.`,
    ...
    `<span style="color:var(--green)">BUG:</span> report something broken (an error or bug) in the game`,
    `<span style="color:var(--yellow)">To learn more about playing Restoria:</span>`,
