...
const HELP: {
  ...
  STATS: [
    `${padStringToLength79(
      `STATS, HP, MP, MV, STR, DEX, CON, INT, WIS, CHA, SPIRIT`
    )}`,
     `${padStringToLength79(
      `SPEED, HITBONUS, DAMAGEBONUS, ARMOR CLASS, REGEN, RESIST, SPELLSAVE`
    )}`,
    `<span style="color:var(--red)">Typing STATS</span> as a command will show you your current HP, MP, and MV.`,
    `<span style="color:var(--red)">HEALTH (HP):</span> how much damage can be taken before death`,
    `<span style="color:var(--red)">MANA (MP):</span> spent to cast spells`,
    `<span style="color:var(--red)">MOVEMENT (MV):</span> spent moving between rooms`,
    ...
    `<span style="color:var(--red)">DEXTERITY (DEX):</span> affects melee combat accuracy, skill success, dodging`,
    `<span style="color:var(--red)">CONSTITUTION (CON):</span> affects max HP, resistance, regeneration`,
    `<span style="color:var(--red)">INTELLIGENCE (INT):</span> affects max MP and mage spells (damage, duration, etc.)`,
    `<span style="color:var(--red)">WISDOM (WIS):</span> affects max MP and cleric spells (healing, duration, etc.)`,
    `<span style="color:var(--red)">CHARISMA (CHA):</span> helps in interactions with mobs `,
    ...
    `<span style="color:var(--red)">SPEED:</span> reduces cooldown for moving between rooms`,
    `<span style="color:var(--red)">HITBONUS:</span> increases chance to land a melee hit`,
