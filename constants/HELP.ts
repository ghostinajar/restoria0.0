...
const HELP: {
  ...
  CHEATSHEET: [
    ...
    `Restoria is made of user-created story enviroments called <span style="color:var(--white)">zones</span>. Each zone contains interactive <span style="color:var(--orange)">rooms</span>, <span style="color:var(--blue_light)">items</span>, and <span style="color:var(--green_light)">mobs</span> (aka creatures and npcs).`,
